...
logical order. Therefore, looking at the slot located at (4,1) of the array, this algorithm plugs in the value that will cover the most interactions needed for the
